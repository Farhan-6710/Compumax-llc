  ...
  return (
    <section className="blog_details_section section_space bg-light">
      <div className="container">
        ...
        <p>
          Delve into the inner workings of IT solutions with Techco's esteemed
          thought leaders. With unparalleled expertise and a wealth of
          experience, our thought leaders provide invaluable insights into the
        ...
        <div className="row align-items-center">
          <div className="col-md-6">
            <ul className="post_meta unordered_list">
              ...
              <li>
                <Link onClick={ClickHandler} href={"/blog"}>
                  <Image src={icon3} alt="Icon Chat" /> {BlogDetails?.comment}{" "}
                  Comments
                </Link>
              </li>
              <li>
          ...
          <div className="row">
            <div className="col-lg-8">
              ...
              <p>
                ...
                leaders offer unparalleled insights that illuminate the path
              </p>
              ...
              <div className="post_author_box">
                ...
                <div className="author_content">
                  ...
                  <p>
                    ...
                    role involves overseeing the creation.
                  </p>
              ...
              <div className="comment_area mb-0">
                ...
                <p className="mb-5">
                  ...
                  marked <sup className="text-primary">*</sup>
                </p>
                <div className="row">
                  <div className="col-md-6">
